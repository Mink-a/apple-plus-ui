...
//   return (
//     <section className={`${styles.container} ${styles.screen}`}>
//       <div className={styles.fontXxl}>
//         <h2>
    ...
    <section className={styles["landing-section"]}>
      <div className={styles["landing-video-wrapper"]}>
        <div>
          ...
          >
            {playing && (
              <button className={styles["pause-btn"]} onClick={pauseVideo} />
            )}
            {!playing && (
              <button className={styles["play-btn"]} onClick={playVideo} />
            )}
          </div>
